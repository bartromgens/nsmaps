...
def test():
    ...
    create_contours_for_station(departure_station, stations, test_config)


def create_contours_for_station(departure_station, stations, config):
    max_zoom = 11
    max_level = 180
    filepaths = []
...
def create_all():
    ...
    for departure_station in stations:
        if departure_station.has_travel_time_data():
            ...
            create_contours_for_station(departure_station, stations, config)
